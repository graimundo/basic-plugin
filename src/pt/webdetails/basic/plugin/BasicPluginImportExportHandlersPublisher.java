...
public class BasicPluginImportExportHandlersPublisher {

  private static final Log logger = LogFactory.getLog( BasicPluginImportExportHandlersPublisher.class );
  ...
  public BasicPluginImportExportHandlersPublisher() {
    this( PentahoSystem.get( IPlatformImporter.class ), PentahoSystem.get( IPlatformMimeResolver.class ) );
  }

  public BasicPluginImportExportHandlersPublisher( IPlatformImporter importer, IPlatformMimeResolver mimeResolver ) {
